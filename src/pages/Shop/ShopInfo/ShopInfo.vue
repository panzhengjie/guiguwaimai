      ...
      <section class="section">
        ...
        <div class="pic-wrapper" ref="pics">
          <ul class="pic-list"  ref="ul">
            <li class="pic-item" ref="li" v-for="(imgLi,index) in info.pics" :key="index">
...
<script>
  ...
  export default {
    ...
    methods:{
      setUlWidth(){
        this.ratingsSroll = new BScroll(this.$refs.shopInfo,{
          scrollY : true,
          click: true
        })
        const piclist = this.$refs.ul
        const picli = this.info.pics.length
        const width = 120
        piclist.style.width = (width+6)*picli-6 +'px'
